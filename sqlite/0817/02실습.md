...
```sql
SELECT waist, is_drinking FROM healthcare WHERE is_drinking = 1 AND waist != '' ORDER BY waist DESC LIMIT 5;
```
...
46642  100
```
<!-- SELECT *,(weight) / ((height * 0.01)*(height * 0.01)) FROM healthcare LIMIT 3; -->
