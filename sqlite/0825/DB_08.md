...
```python
Director.objects.values().get(id=1)
```
...
```python
Genre.objects.values('id', 'title').get(title='드라마')
```
...
```python
movie.director = Director.objects.get(name='봉준호')
movie.genre = Genre.objects.get(title='드라마')
```
...
for movie in movies:
    s = Movie()
    s.director = Director.objects.get(name = movie[0])
    s.genre = Genre.objects.get(title = movie[1])
    s.title = movie[2]
    s.opening_date = movie[3]
    s.running_time = movie[4]
    s.screening = movie[5]
    s.save()
```
...
for movie in Movie.objects.all():
    print(movie.title, movie.screening, movie.director, movie.genre)
```
...
```python
for movie in Movie.objects.all():
     print(movie.title, movie.screening, movie.director.name , movie.genre)
```
...
```python
for movie in Movie.objects.all():
     print(movie.title, movie.screening, movie.director.name , movie.genre.title)
```
...
```python
for movie in Movie.objects.order_by('-opening_date'):
     print(movie.title, movie.opening_date)
```
...
```python
Movie.objects.order_by('opening_date').values()[0]
```
...
for movie in Movie.objects.order_by('opening_date'):
    if movie.screening:
    print(movie.director.name ,movie.title, movie.genre.title, movie.opening_date, movie.screening)
```
...
```python
for movie in Movie.objects.order_by('running_time'):
     if movie.running_time > 119:
         print(movie.director.name ,movie.genre.title, movie.title, movie.opening_date, movie.running_time, movie.screening)
```
...
```python
for movie in Movie.objects.order_by('running_time').filter(running_time__gte=119):
     print(movie.director.name ,movie.genre.title, movie.title, movie.opening_date, movie.running_time, movie.screening)
```
...
```python
for movie in Movie.objects.order_by('opening_date').filter(opening_date__gt="2022-01-01"):
    print(movie.director.name ,movie.genre.title, movie.title, movie.opening_date, movie.running_time, movie.screening)
```
...
```python
for movie in Movie.objects.order_by('opening_date').filter(director = 1, genre = 2):
    print(movie.director.name ,movie.genre.title, movie.title, movie.opening_date, movie.running_time, movie.screening)
```
...
```python
for movie in Movie.objects.order_by('opening_date').exclude(director = 1):
     print(movie.director.name ,movie.genre.title, movie.title, movie.opening_date, movie.running_time, movie.screening)
```